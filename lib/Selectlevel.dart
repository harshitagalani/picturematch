...
import 'package:picturematch/Game_Level.dart';
...
class _Leval_PageState extends State<Leval_Page> {
  ...
  void initState() {
    ...
    for (int i = 0; i < 30; i++) {
      levelstatus[i] = DashBoard.prefs!.getString("levelstatus$i") ?? "panding";
    }

    for (int i = 0; i < 100; i++) {
      time_list[i] = DashBoard.prefs!.getInt("time$i") ?? "";
    }
    temp = true;
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return InkWell(
                                ...
                                child: Container(
                                    alignment: Alignment.center,
                                    child: (levelstatus[(Myind*10)+index]=="win")?Text(
