...
class _Game_LevalState extends State<Game_Leval> {
  List all_img = [];
  List puzzle_img = [];
  List level_ind=[12,16,20,24,28,32,36,40,48,52];
  bool temp = false;
  int a = 0,
      cur_lvl = 0,
      x = 0,
          ...
          child: (temp)
            ...
            child: GridView.builder(
              ...
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                crossAxisCount: 4,
               // mainAxisSpacing: level_ind[widget.cur_ind],crossAxisSpacing: level_ind[widget.cur_ind],
              ),
                ...
                return InkWell(
                            ...
                            actions: [
                              TextButton(
                                  onPressed: () {
                                   ...
                                   // print("LevelNo:${prefs!.getInt("levelno")}");
                  ...
                  child: Visibility(
                      ...
                      replacement: Container(
                        ...
                        decoration: BoxDecoration(
                            border: Border.all(),borderRadius: BorderRadius.circular(8), color: Colors.teal),
                      ),
                      child: Container(
                        height: 400,
                        width: 170,
